    ...
    setTimeout(() => {
      ...
      setComplaints([
        { 
          ...
          beforeImage: 'https://images.unsplash.com/photo-1517336714731-48910b828f85?w=600', // clean MacBook
          afterImage: 'https://images.unsplash.com/photo-1593642634367-d91a135587b5?w=600', // damaged keyboard
        ...
        { 
          ...
          beforeImage: 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=600', // clean lens
          afterImage: 'https://images.unsplash.com/photo-1588104388727-1d4e8f0e5d5e?w=600', // lens with spots/fungus
        ...
        { 
          ...
          beforeImage: 'https://images.unsplash.com/photo-1588104388727-1d4e8f0e5d5e?w=600',
          afterImage: 'https://images.unsplash.com/photo-1588104388727-1d4e8f0e5d5e?w=600',
            ...
            <div className="complaints-list">
              {complaints.map(c => (
                <div key={c.id} className="complaint-card">
                  ...
                  <div className="complaint-status">{c.status}</div>
                  <button 
          ...
          >
            ...
            <div className="modal-body">
              <div className="complaint-detail-grid">
                <div>
                  <strong>Item:</strong> {selectedComplaint.item}
                </div>
                <div>
                  <strong>Complainant:</strong> {selectedComplaint.complainant}
                </div>
                <div>
                  <strong>Against:</strong> {selectedComplaint.against}
                </div>
                <div>
                  <strong>Reported:</strong> {selectedComplaint.date}
                </div>
              </div>
              ...
              <div className="admin-actions">
                ...
                <div className="decision-buttons">
                  <button className="decision-btn responsible" onClick={() => handleAdminDecision('Borrower Responsible')}>
                    Borrower Responsible
                  </button>
                  <button className="decision-btn dismiss" onClick={() => handleAdminDecision('Dismiss Claim')}>
                    Dismiss Claim
                  </button>
                  <button className="decision-btn split" onClick={() => handleAdminDecision('Split 50/50')}>
                    Split Cost (50/50)
                  </button>
                  <button className="decision-btn more-info" onClick={() => handleAdminDecision('Request More Info')}>
                    Request More Info
                  </button>
                </div>
              </div>
