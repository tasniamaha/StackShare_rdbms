...
CREATE TABLE notifications (
    ...
    notification_type ENUM('borrow_request','borrow_approved','borrow_rejected','return_reminder','damage_report','fine_issued','fine_paid','system','reputation_update','waitlist_expired','waitlist_turn','waitlist_ready'),
